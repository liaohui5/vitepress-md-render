...
export const containerPlugin = (md: MarkdownItAsync, options?: ContainerOptions) => {
...
function createContainer(klass: string, defaultTitle: string, md: MarkdownItAsync): ContainerArgs {
  return [
    container,
    klass,
    {
